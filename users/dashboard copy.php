...
<body>
    ...
    <div class="">
        <div class="container">
            ...
            <div class="top-products-container bg-light p-3">
                <div class="d-flex justify-content-between">
                    <h4 class="text-success">Top Products</h4>
                    <a href="all_top_products.php" class="text-muted">See All &gt;</a>
                </div>

                <!-- Horizontal Scroll for Top Products -->
                <div class="top-products d-flex overflow-auto p-2">
                    <?php
                    ...
                    ?>
                            <div class="top-product-item text-center me-3" style="min-width: 150px;">
                                <div class="position-relative">
                                    <!-- Product Image -->
                                    <a href='view_product.php?ProductID=<?php echo $row_top["ProductID"]; ?>' class='d-block'>
                                        <img src='../admin/management/<?php echo $row_top["Photo"]; ?>' alt='Top Product Image' class='img-fluid mb-2' style="height: 120px; object-fit: contain;">
                                    </a>
                                    <!-- "TOP" Badge -->
                                    <span class="badge bg-danger position-absolute top-0 start-0">TOP</span>
                                </div>
                                <!-- Product Name -->
                                <p class='product-name fw-bold m-0'><?php echo $row_top["ProductName"]; ?></p>
                                <!-- Monthly Sales -->
