...
// Fetch total number of shipped orders for pagination
...
$result = $conn->query($sql);
$shipped_count_sql = "SELECT COUNT(*) AS shipped_count FROM orders WHERE OrderStatus = 'shipped'";
$shipped_count_result = $conn->query($shipped_count_sql);
$shipped_count = $shipped_count_result->fetch_assoc()['shipped_count'];
            ...
            <div class="container-fluid">
                <div class="pt-2 pb-5">
                    <div class="head pb-2">
                        ...
                        <p class="shipped-header text-center h4 fw-bold text-light" style="font-style: italic; font-family: cursive; "><i class="fa-solid fa-fire"></i> List of Shipping</p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="orders-table-container">
                                <div class="header-container">
                                    ...
                                    <table class="admin-dashboard">
                                        <thead>
                                            <tr class="fw-bold fs-5 bg bg-success text-light">
                                                <!-- <th></th> -->
                                                <th colspan="9">Shipping
                                                    <span style="font-size: 12px;" class="badge text-bg-danger"><?php echo htmlspecialchars($shipped_count); ?></span>
                                                </th>
                                    ...
                                    <?php include 'modal/modal_shipping.php'; ?>
                                </div>
                            </div>
                        </div>
                    </div>
