...
// Fetch total number of processing orders for pagination
            ...
            <div class="container-fluid pt-5">
                <div class="pt-2 pb-5">
                    <div class="head pb-2">
                        ...
                        <p class="processing-header text-center h4 fw-bold text-light" style="font-style: italic; font-family: cursive; "><i class="fa-solid fa-fire"></i> List of Processing</p>
                        ...
                        <div class="card-body">
                            ...
                            <div class="orders-table-container">
                                <div class="header-container">
                                    ...
                                    <?php include 'modal/modal_processing.php'; ?>
                                </div>
                            </div>
                        </div>
                    </div>
